...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            {
                name: 'Insta',
                link: 'https://instagram.com/jap.b_'
            },
            
            {
                name: 'Steam',
                link: 'https://steamcommunity.com/id/main121/'
            },
		
	    {
                name: 'Snapchat',
                link: 'https://www.snapchat.com/add/japbrar21?share_id=RkNBMzNG&locale=en_IN'
            }            
        ];
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #06d;'>[Jap Site]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>JAP#2946</i>"], 120, 500, function () {
